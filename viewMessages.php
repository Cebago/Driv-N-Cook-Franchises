    ...
    <div class="col-md-10">
        <table class="table table-striped table-bordered table-hover table-hover-cursor" style="table-layout: fixed"
            ...
            foreach ($messages as $message) {
                ...
                <tr <?php echo $message["isRead"] ? '' : 'style="font-weight: bold"' ?>
                        id="row<?php echo $message["idContact"] ?>" class="d-flex">
                    <td class="text-truncate col-2"><?php echo $message["firstname"] . ' ' . $message["lastname"] ?></
                    </td>
                    ...
                    <td class="col-1">
                        <button type="button" class="btn btn-success btn-sm" data-toggle="modal"
                                onclick="readMessage(<?php echo $message["idContact"] ?>)"
