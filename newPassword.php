...
<div class="col-md-11 mx-auto mt-5">
    <div class="mt-5">
        <h5 class="mx-auto" id="changePassword">Définir mon mot de passe</h5>
        <div>
            <?php
        ...
        <form class="col-md-11 mx-auto mt-5" action="./functions/setPassword.php" method="POST">
            ...
            <div class="mt-5 col-md-2 mx-auto">
                <button class="btn btn-warning" type="submit">Définir le mot de passe</button>
            </div>
        </form>
    </div>
</div>
