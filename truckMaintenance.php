...
?>
    ...
    <div class="col-md-5">
        <button class="btn btn-danger mb-5 mr-5 ml-5" data-toggle="modal" data-target="#incident">Enregistrer une maintenance/incident</button>
    </div>
    ...
    <div class="modal fade" id="validModal" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
